...
class HomeController extends Controller
{
    public function index(){
        $config = array(
            ...
            'extractor' => array(
                ...
                'config_builder' => array(
                    ...
                    'site_config' => array(storage_path('app/graby')),
        ...
        //$article = 'https://www.producthunt.com/alternatives/pocket-for-web';
        $article = 'https://medium.com/employbl/build-authentication-into-your-laravel-api-with-json-web-tokens-jwt-cd223ace8d1a?gi=c82b3238906f/';
        $graby = new Graby($config);
        $guzzle = new GuzzleClient([
            'timeout' => 2,
        ]);
        //$graby = new Graby($config, new GuzzleAdapter($guzzle));
